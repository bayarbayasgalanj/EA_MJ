...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // List<Person> flights = em.createQuery("from People ", Person.class).getResultList();
        // System.out.printf("%-9s%-31s%-31s\n", "Flight:", "Departs:",
        //         "Arrives:");
        // for (Person flight : flights) {
        //     System.out.printf("%s %s %s\n", flight.getId(), flight.getFirstname(), flight.getPets());
        // }
        // System.out.println();
